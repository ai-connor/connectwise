...
type ApiPostSalesOrdersByIdConvertToProjectRequest struct {
	ctx context.Context
	ApiService *OrdersAPIService
	id int32
	orderToProjectConversion *OrderToProjectConversion
	clientId *string
}

// conversion
func (r ApiPostSalesOrdersByIdConvertToProjectRequest) OrderToProjectConversion(orderToProjectConversion OrderToProjectConversion) ApiPostSalesOrdersByIdConvertToProjectRequest {
	r.orderToProjectConversion = &orderToProjectConversion
	return r
}

// 
func (r ApiPostSalesOrdersByIdConvertToProjectRequest) ClientId(clientId string) ApiPostSalesOrdersByIdConvertToProjectRequest {
	r.clientId = &clientId
	return r
}

func (r ApiPostSalesOrdersByIdConvertToProjectRequest) Execute() (*Project, *http.Response, error) {
	return r.ApiService.PostSalesOrdersByIdConvertToProjectExecute(r)
}

/*
PostSalesOrdersByIdConvertToProject Post ApiProject

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id orderId
 @return ApiPostSalesOrdersByIdConvertToProjectRequest
*/
func (a *OrdersAPIService) PostSalesOrdersByIdConvertToProject(ctx context.Context, id int32) ApiPostSalesOrdersByIdConvertToProjectRequest {
	return ApiPostSalesOrdersByIdConvertToProjectRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Project
func (a *OrdersAPIService) PostSalesOrdersByIdConvertToProjectExecute(r ApiPostSalesOrdersByIdConvertToProjectRequest) (*Project, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrdersAPIService.PostSalesOrdersByIdConvertToProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sales/orders/{id}/convertToProject"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.orderToProjectConversion == nil {
		return localVarReturnValue, nil, reportError("orderToProjectConversion is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.orderToProjectConversion
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
