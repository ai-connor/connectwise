...
/*
GetServiceTickets Get List of ConnectWise.Apis.v3_0.v2015_3.Service.Ticket.Ticket              To obtain the current SLA times for an active ticket, please use the /service/tickets/calculateSLA endpoint for multiple tickets or /service/tickets/{id} for individual tickets.
