...
// checks if the ChargeCodeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChargeCodeReference{}

// ChargeCodeReference struct for ChargeCodeReference
...
func (o *ChargeCodeReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o ChargeCodeReference) MarshalJSON() ([]byte, error) {
...
func (o ChargeCodeReference) ToMap() (map[string]interface{}, error) {
...
type NullableChargeCodeReference struct {
	value *ChargeCodeReference
	isSet bool
}

func (v NullableChargeCodeReference) Get() *ChargeCodeReference {
	return v.value
}

func (v *NullableChargeCodeReference) Set(val *ChargeCodeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableChargeCodeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableChargeCodeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChargeCodeReference(val *ChargeCodeReference) *NullableChargeCodeReference {
	return &NullableChargeCodeReference{value: val, isSet: true}
}

func (v NullableChargeCodeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChargeCodeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
