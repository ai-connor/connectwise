...
// checks if the CountryReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountryReference{}

// CountryReference struct for CountryReference
...
func (o *CountryReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o CountryReference) MarshalJSON() ([]byte, error) {
...
func (o CountryReference) ToMap() (map[string]interface{}, error) {
...
type NullableCountryReference struct {
	value *CountryReference
	isSet bool
}

func (v NullableCountryReference) Get() *CountryReference {
	return v.value
}

func (v *NullableCountryReference) Set(val *CountryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCountryReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCountryReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountryReference(val *CountryReference) *NullableCountryReference {
	return &NullableCountryReference{value: val, isSet: true}
}

func (v NullableCountryReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountryReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
