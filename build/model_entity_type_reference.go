...
// checks if the EntityTypeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityTypeReference{}

// EntityTypeReference struct for EntityTypeReference
...
func (o *EntityTypeReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o EntityTypeReference) MarshalJSON() ([]byte, error) {
...
func (o EntityTypeReference) ToMap() (map[string]interface{}, error) {
...
func (v NullableEntityTypeReference) Get() *EntityTypeReference {
	return v.value
}

func (v *NullableEntityTypeReference) Set(val *EntityTypeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityTypeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityTypeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityTypeReference(val *EntityTypeReference) *NullableEntityTypeReference {
	return &NullableEntityTypeReference{value: val, isSet: true}
}

func (v NullableEntityTypeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityTypeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
