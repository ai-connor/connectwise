...
// checks if the GroupReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupReference{}

// GroupReference struct for GroupReference
...
func (o *GroupReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o GroupReference) MarshalJSON() ([]byte, error) {
...
func (o GroupReference) ToMap() (map[string]interface{}, error) {
...
func (v NullableGroupReference) Get() *GroupReference {
	return v.value
}

func (v *NullableGroupReference) Set(val *GroupReference) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupReference) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupReference(val *GroupReference) *NullableGroupReference {
	return &NullableGroupReference{value: val, isSet: true}
}

func (v NullableGroupReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
