...
// checks if the PortalConfigurationReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortalConfigurationReference{}

// PortalConfigurationReference struct for PortalConfigurationReference
...
func NewPortalConfigurationReference() *PortalConfigurationReference {
	this := PortalConfigurationReference{}
	return &this
}
...
func (o *PortalConfigurationReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o PortalConfigurationReference) MarshalJSON() ([]byte, error) {
...
func (o PortalConfigurationReference) ToMap() (map[string]interface{}, error) {
...
type NullablePortalConfigurationReference struct {
	value *PortalConfigurationReference
	isSet bool
}

func (v NullablePortalConfigurationReference) Get() *PortalConfigurationReference {
	return v.value
}

func (v *NullablePortalConfigurationReference) Set(val *PortalConfigurationReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePortalConfigurationReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePortalConfigurationReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortalConfigurationReference(val *PortalConfigurationReference) *NullablePortalConfigurationReference {
	return &NullablePortalConfigurationReference{value: val, isSet: true}
}

func (v NullablePortalConfigurationReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortalConfigurationReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
