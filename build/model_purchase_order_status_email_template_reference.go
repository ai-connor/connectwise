...
// checks if the PurchaseOrderStatusEmailTemplateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PurchaseOrderStatusEmailTemplateReference{}

// PurchaseOrderStatusEmailTemplateReference struct for PurchaseOrderStatusEmailTemplateReference
...
func NewPurchaseOrderStatusEmailTemplateReference() *PurchaseOrderStatusEmailTemplateReference {
	this := PurchaseOrderStatusEmailTemplateReference{}
	return &this
}
...
func (o *PurchaseOrderStatusEmailTemplateReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o PurchaseOrderStatusEmailTemplateReference) MarshalJSON() ([]byte, error) {
...
func (o PurchaseOrderStatusEmailTemplateReference) ToMap() (map[string]interface{}, error) {
...
type NullablePurchaseOrderStatusEmailTemplateReference struct {
	value *PurchaseOrderStatusEmailTemplateReference
	isSet bool
}

func (v NullablePurchaseOrderStatusEmailTemplateReference) Get() *PurchaseOrderStatusEmailTemplateReference {
	return v.value
}

func (v *NullablePurchaseOrderStatusEmailTemplateReference) Set(val *PurchaseOrderStatusEmailTemplateReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePurchaseOrderStatusEmailTemplateReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePurchaseOrderStatusEmailTemplateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePurchaseOrderStatusEmailTemplateReference(val *PurchaseOrderStatusEmailTemplateReference) *NullablePurchaseOrderStatusEmailTemplateReference {
	return &NullablePurchaseOrderStatusEmailTemplateReference{value: val, isSet: true}
}

func (v NullablePurchaseOrderStatusEmailTemplateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePurchaseOrderStatusEmailTemplateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
