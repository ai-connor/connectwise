...
// checks if the RmaStatusEmailTemplateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RmaStatusEmailTemplateReference{}

// RmaStatusEmailTemplateReference struct for RmaStatusEmailTemplateReference
...
func NewRmaStatusEmailTemplateReference() *RmaStatusEmailTemplateReference {
	this := RmaStatusEmailTemplateReference{}
	return &this
}
...
func (o *RmaStatusEmailTemplateReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o RmaStatusEmailTemplateReference) MarshalJSON() ([]byte, error) {
...
func (o RmaStatusEmailTemplateReference) ToMap() (map[string]interface{}, error) {
...
type NullableRmaStatusEmailTemplateReference struct {
	value *RmaStatusEmailTemplateReference
	isSet bool
}

func (v NullableRmaStatusEmailTemplateReference) Get() *RmaStatusEmailTemplateReference {
	return v.value
}

func (v *NullableRmaStatusEmailTemplateReference) Set(val *RmaStatusEmailTemplateReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRmaStatusEmailTemplateReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRmaStatusEmailTemplateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRmaStatusEmailTemplateReference(val *RmaStatusEmailTemplateReference) *NullableRmaStatusEmailTemplateReference {
	return &NullableRmaStatusEmailTemplateReference{value: val, isSet: true}
}

func (v NullableRmaStatusEmailTemplateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRmaStatusEmailTemplateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
