...
// checks if the StateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StateReference{}

// StateReference struct for StateReference
...
func (o *StateReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o StateReference) MarshalJSON() ([]byte, error) {
...
func (o StateReference) ToMap() (map[string]interface{}, error) {
...
func (v NullableStateReference) Get() *StateReference {
	return v.value
}

func (v *NullableStateReference) Set(val *StateReference) {
	v.value = val
	v.isSet = true
}

func (v NullableStateReference) IsSet() bool {
	return v.isSet
}

func (v *NullableStateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStateReference(val *StateReference) *NullableStateReference {
	return &NullableStateReference{value: val, isSet: true}
}

func (v NullableStateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
