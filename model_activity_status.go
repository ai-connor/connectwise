...
func (o *ActivityStatus) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ActivityStatus) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ActivityStatus) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ActivityStatus) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *ActivityStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varActivityStatus)
	...
	*o = ActivityStatus(varActivityStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "spawnFollowupFlag")
