...
func (o *ActivityType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ActivityType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ActivityType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ActivityType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *ActivityType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varActivityType)
	...
	*o = ActivityType(varActivityType)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "memoFlag")
		delete(additionalProperties, "historyFlag")
