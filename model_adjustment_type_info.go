...
// checks if the AdjustmentTypeInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdjustmentTypeInfo{}

// AdjustmentTypeInfo struct for AdjustmentTypeInfo
...
func (o AdjustmentTypeInfo) MarshalJSON() ([]byte, error) {
...
func (o AdjustmentTypeInfo) ToMap() (map[string]interface{}, error) {
...
type NullableAdjustmentTypeInfo struct {
	value *AdjustmentTypeInfo
	isSet bool
}

func (v NullableAdjustmentTypeInfo) Get() *AdjustmentTypeInfo {
	return v.value
}

func (v *NullableAdjustmentTypeInfo) Set(val *AdjustmentTypeInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableAdjustmentTypeInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableAdjustmentTypeInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdjustmentTypeInfo(val *AdjustmentTypeInfo) *NullableAdjustmentTypeInfo {
	return &NullableAdjustmentTypeInfo{value: val, isSet: true}
}

func (v NullableAdjustmentTypeInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdjustmentTypeInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
