...
// checks if the AgreementRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgreementRevenueReference{}

// AgreementRevenueReference struct for AgreementRevenueReference
...
type _AgreementRevenueReference AgreementRevenueReference
...
func NewAgreementRevenueReference() *AgreementRevenueReference {
	this := AgreementRevenueReference{}
	return &this
}
...
func (o *AgreementRevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *AgreementRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *AgreementRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AgreementRevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AgreementRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *AgreementRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *AgreementRevenueReference) SetPercentageNil() {
...
func (o *AgreementRevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o AgreementRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o AgreementRevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *AgreementRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varAgreementRevenueReference := _AgreementRevenueReference{}

	err = json.Unmarshal(data, &varAgreementRevenueReference)

	if err != nil {
		return err
	}

	*o = AgreementRevenueReference(varAgreementRevenueReference)
...
type NullableAgreementRevenueReference struct {
	value *AgreementRevenueReference
	isSet bool
}

func (v NullableAgreementRevenueReference) Get() *AgreementRevenueReference {
	return v.value
}

func (v *NullableAgreementRevenueReference) Set(val *AgreementRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAgreementRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAgreementRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgreementRevenueReference(val *AgreementRevenueReference) *NullableAgreementRevenueReference {
	return &NullableAgreementRevenueReference{value: val, isSet: true}
}

func (v NullableAgreementRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgreementRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
