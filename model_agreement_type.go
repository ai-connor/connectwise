...
func (o *AgreementType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *AgreementType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *AgreementType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *AgreementType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
