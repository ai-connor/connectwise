...
func (o *BillingSetup) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *BillingSetup) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *BillingSetup) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *BillingSetup) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
