...
// checks if the BillingTermInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingTermInfo{}

// BillingTermInfo struct for BillingTermInfo
...
type _BillingTermInfo BillingTermInfo
...
func (o *BillingTermInfo) SetDefaultFlagNil() {
...
func (o BillingTermInfo) MarshalJSON() ([]byte, error) {
...
func (o BillingTermInfo) ToMap() (map[string]interface{}, error) {
...
func (o *BillingTermInfo) UnmarshalJSON(data []byte) (err error) {
	varBillingTermInfo := _BillingTermInfo{}

	err = json.Unmarshal(data, &varBillingTermInfo)

	if err != nil {
		return err
	}

	*o = BillingTermInfo(varBillingTermInfo)
...
type NullableBillingTermInfo struct {
	value *BillingTermInfo
	isSet bool
}

func (v NullableBillingTermInfo) Get() *BillingTermInfo {
	return v.value
}

func (v *NullableBillingTermInfo) Set(val *BillingTermInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingTermInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingTermInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingTermInfo(val *BillingTermInfo) *NullableBillingTermInfo {
	return &NullableBillingTermInfo{value: val, isSet: true}
}

func (v NullableBillingTermInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingTermInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
