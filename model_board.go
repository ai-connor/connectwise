...
func (o *Board) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *Board) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *Board) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *Board) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
