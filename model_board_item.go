...
func (o *BoardItem) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *BoardItem) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *BoardItem) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *BoardItem) GetParentConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ParentConnectWiseId) {
		return nil, false
	}
...
func (o *BoardItem) HasParentConnectWiseId() bool {
	if o != nil && !IsNil(o.ParentConnectWiseId) {
		return true
	}
...
func (o *BoardItem) SetParentConnectWiseId(v string) {
	o.ParentConnectWiseId = &v
}

// GetParentId returns the ParentId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BoardItem) GetParentId() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BoardItem) GetParentIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BoardItem) HasParentId() bool {
...
func (o *BoardItem) SetParentId(v int32) {
	o.ParentId.Set(&v)
}
// SetParentIdNil sets the value for ParentId to be an explicit nil
func (o *BoardItem) SetParentIdNil() {
	o.ParentId.Set(nil)
}

// UnsetParentId ensures that no value is present for ParentId, not even an explicit nil
func (o *BoardItem) UnsetParentId() {
	o.ParentId.Unset()
}
...
func (o *BoardItem) GetGrandParentId() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BoardItem) GetGrandParentIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BoardItem) HasGrandParentId() bool {
...
func (o *BoardItem) GetGrandParentConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *BoardItem) GetGrandParentConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.GrandParentConnectWiseId) {
		return nil, false
	}
...
func (o *BoardItem) HasGrandParentConnectWiseId() bool {
	if o != nil && !IsNil(o.GrandParentConnectWiseId) {
		return true
	}
...
func (o *BoardItem) SetGrandParentConnectWiseId(v string) {
...
func (o *BoardItem) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBoardItem)
