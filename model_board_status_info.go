...
type _BoardStatusInfo BoardStatusInfo
...
func (o *BoardStatusInfo) UnmarshalJSON(data []byte) (err error) {
	varBoardStatusInfo := _BoardStatusInfo{}

	err = json.Unmarshal(data, &varBoardStatusInfo)

	if err != nil {
		return err
	}

	*o = BoardStatusInfo(varBoardStatusInfo)
