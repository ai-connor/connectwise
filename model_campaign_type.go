...
// checks if the CampaignType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignType{}

// CampaignType struct for CampaignType
...
type _CampaignType CampaignType
...
func (o *CampaignType) SetDefaultFlagNil() {
...
func (o CampaignType) MarshalJSON() ([]byte, error) {
...
func (o CampaignType) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignType) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignType := _CampaignType{}

	err = json.Unmarshal(data, &varCampaignType)

	if err != nil {
		return err
	}

	*o = CampaignType(varCampaignType)
