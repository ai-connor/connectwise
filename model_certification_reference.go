...
func (o *CertificationReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *CertificationReference) UnmarshalJSON(data []byte) (err error) {
	varCertificationReference := _CertificationReference{}

	err = json.Unmarshal(data, &varCertificationReference)
