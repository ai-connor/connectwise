...
func (o *CommunicationType) GetDisabled() bool {
...
// and a boolean to check if the value has been set.
func (o *CommunicationType) GetDisabledOk() (*bool, bool) {
	if o == nil || IsNil(o.Disabled) {
		return nil, false
	}
...
func (o *CommunicationType) HasDisabled() bool {
	if o != nil && !IsNil(o.Disabled) {
		return true
	}
...
func (o *CommunicationType) SetDisabled(v bool) {
	o.Disabled = &v
}
