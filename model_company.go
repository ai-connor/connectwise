...
type Company struct {
	...
	CreditLimit NullableFloat64 `json:"creditLimit,omitempty"`
	AdditionalDebt NullableFloat64 `json:"additionalDebt,omitempty"`
...
func (o *Company) GetCreditLimit() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Company) GetCreditLimitOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Company) HasCreditLimit() bool {
...
// SetCreditLimit gets a reference to the given NullableFloat64 and assigns it to the CreditLimit field.
func (o *Company) SetCreditLimit(v float64) {
	o.CreditLimit.Set(&v)
}
// SetCreditLimitNil sets the value for CreditLimit to be an explicit nil
func (o *Company) SetCreditLimitNil() {
	o.CreditLimit.Set(nil)
}

// UnsetCreditLimit ensures that no value is present for CreditLimit, not even an explicit nil
func (o *Company) UnsetCreditLimit() {
	o.CreditLimit.Unset()
}

// GetAdditionalDebt returns the AdditionalDebt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Company) GetAdditionalDebt() float64 {
	if o == nil || IsNil(o.AdditionalDebt.Get()) {
		var ret float64
		return ret
	}
	return *o.AdditionalDebt.Get()
}

// GetAdditionalDebtOk returns a tuple with the AdditionalDebt field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Company) GetAdditionalDebtOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
	return o.AdditionalDebt.Get(), o.AdditionalDebt.IsSet()
}

// HasAdditionalDebt returns a boolean if a field has been set.
func (o *Company) HasAdditionalDebt() bool {
	if o != nil && o.AdditionalDebt.IsSet() {
		return true
	}
...
// SetAdditionalDebt gets a reference to the given NullableFloat64 and assigns it to the AdditionalDebt field.
func (o *Company) SetAdditionalDebt(v float64) {
	o.AdditionalDebt.Set(&v)
}
// SetAdditionalDebtNil sets the value for AdditionalDebt to be an explicit nil
func (o *Company) SetAdditionalDebtNil() {
	o.AdditionalDebt.Set(nil)
}

// UnsetAdditionalDebt ensures that no value is present for AdditionalDebt, not even an explicit nil
func (o *Company) UnsetAdditionalDebt() {
	o.AdditionalDebt.Unset()
}
...
func (o Company) ToMap() (map[string]interface{}, error) {
	...
	if o.AdditionalDebt.IsSet() {
		toSerialize["additionalDebt"] = o.AdditionalDebt.Get()
	}
