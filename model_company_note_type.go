...
func (o *CompanyNoteType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *CompanyNoteType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *CompanyNoteType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *CompanyNoteType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
