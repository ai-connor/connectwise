...
// checks if the CompanyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompanyReference{}

// CompanyReference struct for CompanyReference
...
func (o *CompanyReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o CompanyReference) MarshalJSON() ([]byte, error) {
...
func (o CompanyReference) ToMap() (map[string]interface{}, error) {
...
func (v NullableCompanyReference) Get() *CompanyReference {
	return v.value
}

func (v *NullableCompanyReference) Set(val *CompanyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyReference(val *CompanyReference) *NullableCompanyReference {
	return &NullableCompanyReference{value: val, isSet: true}
}

func (v NullableCompanyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
