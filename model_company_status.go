...
func (o *CompanyStatus) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *CompanyStatus) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *CompanyStatus) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *CompanyStatus) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
