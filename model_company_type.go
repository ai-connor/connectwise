...
func (o *CompanyType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *CompanyType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *CompanyType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *CompanyType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *CompanyType) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CompanyType(varCompanyType)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "vendorFlag")
