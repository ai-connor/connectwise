...
type _ConfigurationReference ConfigurationReference
...
func (o *ConfigurationReference) UnmarshalJSON(data []byte) (err error) {
	varConfigurationReference := _ConfigurationReference{}

	err = json.Unmarshal(data, &varConfigurationReference)

	if err != nil {
		return err
	}

	*o = ConfigurationReference(varConfigurationReference)
