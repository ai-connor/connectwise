...
func (o *ConfigurationStatus) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ConfigurationStatus) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ConfigurationStatus) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ConfigurationStatus) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *ConfigurationStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConfigurationStatus)
