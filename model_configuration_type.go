...
func (o *ConfigurationType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ConfigurationType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ConfigurationType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ConfigurationType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *ConfigurationType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConfigurationType)
