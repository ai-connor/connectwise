...
func (o *ContactDepartment) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ContactDepartment) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ContactDepartment) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ContactDepartment) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *ContactDepartment) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varContactDepartment)
