...
func (o *ContactType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ContactType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ContactType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ContactType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
