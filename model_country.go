...
func (o *Country) GetDisabled() bool {
...
// and a boolean to check if the value has been set.
func (o *Country) GetDisabledOk() (*bool, bool) {
	if o == nil || IsNil(o.Disabled) {
		return nil, false
	}
...
func (o *Country) HasDisabled() bool {
	if o != nil && !IsNil(o.Disabled) {
		return true
	}
...
func (o *Country) SetDisabled(v bool) {
	o.Disabled = &v
}
...
func (o *Country) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *Country) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *Country) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *Country) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
