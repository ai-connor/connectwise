...
// GetGuidSecondary returns the GuidSecondary field value if set, zero value otherwise.
func (o *DocumentInfo) GetGuidSecondary() string {
	if o == nil || IsNil(o.GuidSecondary) {
		var ret string
		return ret
	}
	return *o.GuidSecondary
}

// GetGuidSecondaryOk returns a tuple with the GuidSecondary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentInfo) GetGuidSecondaryOk() (*string, bool) {
	if o == nil || IsNil(o.GuidSecondary) {
		return nil, false
	}
	return o.GuidSecondary, true
}

// HasGuidSecondary returns a boolean if a field has been set.
func (o *DocumentInfo) HasGuidSecondary() bool {
	if o != nil && !IsNil(o.GuidSecondary) {
		return true
	}
...
// SetGuidSecondary gets a reference to the given string and assigns it to the GuidSecondary field.
func (o *DocumentInfo) SetGuidSecondary(v string) {
	o.GuidSecondary = &v
}
...
func (o DocumentInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GuidSecondary) {
		toSerialize["guidSecondary"] = o.GuidSecondary
	}
	if !IsNil(o.Info) {
