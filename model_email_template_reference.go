...
// checks if the EmailTemplateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailTemplateReference{}

// EmailTemplateReference struct for EmailTemplateReference
...
func (o *EmailTemplateReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o EmailTemplateReference) MarshalJSON() ([]byte, error) {
...
func (o EmailTemplateReference) ToMap() (map[string]interface{}, error) {
...
func (v NullableEmailTemplateReference) Get() *EmailTemplateReference {
	return v.value
}

func (v *NullableEmailTemplateReference) Set(val *EmailTemplateReference) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailTemplateReference) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailTemplateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailTemplateReference(val *EmailTemplateReference) *NullableEmailTemplateReference {
	return &NullableEmailTemplateReference{value: val, isSet: true}
}

func (v NullableEmailTemplateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailTemplateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
