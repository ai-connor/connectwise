...
// checks if the ExpenseRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpenseRevenueReference{}

// ExpenseRevenueReference struct for ExpenseRevenueReference
...
type _ExpenseRevenueReference ExpenseRevenueReference
...
func (o *ExpenseRevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *ExpenseRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ExpenseRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExpenseRevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExpenseRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *ExpenseRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *ExpenseRevenueReference) SetPercentageNil() {
...
func (o *ExpenseRevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o ExpenseRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o ExpenseRevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *ExpenseRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varExpenseRevenueReference := _ExpenseRevenueReference{}

	err = json.Unmarshal(data, &varExpenseRevenueReference)

	if err != nil {
		return err
	}

	*o = ExpenseRevenueReference(varExpenseRevenueReference)
...
type NullableExpenseRevenueReference struct {
	value *ExpenseRevenueReference
	isSet bool
}

func (v NullableExpenseRevenueReference) Get() *ExpenseRevenueReference {
	return v.value
}

func (v *NullableExpenseRevenueReference) Set(val *ExpenseRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseRevenueReference(val *ExpenseRevenueReference) *NullableExpenseRevenueReference {
	return &NullableExpenseRevenueReference{value: val, isSet: true}
}

func (v NullableExpenseRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
