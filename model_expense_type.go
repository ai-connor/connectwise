...
func (o *ExpenseType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ExpenseType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ExpenseType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ExpenseType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
