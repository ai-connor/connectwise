...
// checks if the ForecastRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForecastRevenueReference{}

// ForecastRevenueReference struct for ForecastRevenueReference
...
type _ForecastRevenueReference ForecastRevenueReference
...
func (o *ForecastRevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *ForecastRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ForecastRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ForecastRevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ForecastRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *ForecastRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *ForecastRevenueReference) SetPercentageNil() {
...
func (o *ForecastRevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o ForecastRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o ForecastRevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *ForecastRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varForecastRevenueReference := _ForecastRevenueReference{}

	err = json.Unmarshal(data, &varForecastRevenueReference)

	if err != nil {
		return err
	}

	*o = ForecastRevenueReference(varForecastRevenueReference)
...
type NullableForecastRevenueReference struct {
	value *ForecastRevenueReference
	isSet bool
}

func (v NullableForecastRevenueReference) Get() *ForecastRevenueReference {
	return v.value
}

func (v *NullableForecastRevenueReference) Set(val *ForecastRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableForecastRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableForecastRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForecastRevenueReference(val *ForecastRevenueReference) *NullableForecastRevenueReference {
	return &NullableForecastRevenueReference{value: val, isSet: true}
}

func (v NullableForecastRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForecastRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
