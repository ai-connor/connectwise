...
type _InclusiveRevenueReference InclusiveRevenueReference
...
func (o *InclusiveRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varInclusiveRevenueReference := _InclusiveRevenueReference{}

	err = json.Unmarshal(data, &varInclusiveRevenueReference)

	if err != nil {
		return err
	}

	*o = InclusiveRevenueReference(varInclusiveRevenueReference)
