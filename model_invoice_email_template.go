...
func (o *InvoiceEmailTemplate) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *InvoiceEmailTemplate) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *InvoiceEmailTemplate) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *InvoiceEmailTemplate) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
