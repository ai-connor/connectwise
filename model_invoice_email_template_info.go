...
type _InvoiceEmailTemplateInfo InvoiceEmailTemplateInfo
...
func (o *InvoiceEmailTemplateInfo) UnmarshalJSON(data []byte) (err error) {
	varInvoiceEmailTemplateInfo := _InvoiceEmailTemplateInfo{}

	err = json.Unmarshal(data, &varInvoiceEmailTemplateInfo)

	if err != nil {
		return err
	}

	*o = InvoiceEmailTemplateInfo(varInvoiceEmailTemplateInfo)
