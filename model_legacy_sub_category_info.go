...
// checks if the LegacySubCategoryInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LegacySubCategoryInfo{}

// LegacySubCategoryInfo struct for LegacySubCategoryInfo
...
func (o *LegacySubCategoryInfo) SetInactiveFlagNil() {
...
func (o LegacySubCategoryInfo) MarshalJSON() ([]byte, error) {
...
func (o LegacySubCategoryInfo) ToMap() (map[string]interface{}, error) {
...
type NullableLegacySubCategoryInfo struct {
	value *LegacySubCategoryInfo
	isSet bool
}

func (v NullableLegacySubCategoryInfo) Get() *LegacySubCategoryInfo {
	return v.value
}

func (v *NullableLegacySubCategoryInfo) Set(val *LegacySubCategoryInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableLegacySubCategoryInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableLegacySubCategoryInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLegacySubCategoryInfo(val *LegacySubCategoryInfo) *NullableLegacySubCategoryInfo {
	return &NullableLegacySubCategoryInfo{value: val, isSet: true}
}

func (v NullableLegacySubCategoryInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLegacySubCategoryInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
