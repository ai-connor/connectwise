...
type _LostRevenueReference LostRevenueReference
...
func (o *LostRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varLostRevenueReference := _LostRevenueReference{}

	err = json.Unmarshal(data, &varLostRevenueReference)

	if err != nil {
		return err
	}

	*o = LostRevenueReference(varLostRevenueReference)
