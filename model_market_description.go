...
func (o *MarketDescription) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *MarketDescription) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *MarketDescription) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *MarketDescription) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *MarketDescription) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMarketDescription)
