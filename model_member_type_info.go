...
type _MemberTypeInfo MemberTypeInfo
...
func (o *MemberTypeInfo) UnmarshalJSON(data []byte) (err error) {
	varMemberTypeInfo := _MemberTypeInfo{}

	err = json.Unmarshal(data, &varMemberTypeInfo)

	if err != nil {
		return err
	}

	*o = MemberTypeInfo(varMemberTypeInfo)
