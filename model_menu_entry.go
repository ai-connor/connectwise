...
func (o *MenuEntry) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *MenuEntry) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *MenuEntry) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *MenuEntry) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
