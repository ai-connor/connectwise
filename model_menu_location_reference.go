...
// checks if the MenuLocationReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MenuLocationReference{}

// MenuLocationReference struct for MenuLocationReference
...
func (o *MenuLocationReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o MenuLocationReference) MarshalJSON() ([]byte, error) {
...
func (o MenuLocationReference) ToMap() (map[string]interface{}, error) {
...
type NullableMenuLocationReference struct {
	value *MenuLocationReference
	isSet bool
}

func (v NullableMenuLocationReference) Get() *MenuLocationReference {
	return v.value
}

func (v *NullableMenuLocationReference) Set(val *MenuLocationReference) {
	v.value = val
	v.isSet = true
}

func (v NullableMenuLocationReference) IsSet() bool {
	return v.isSet
}

func (v *NullableMenuLocationReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMenuLocationReference(val *MenuLocationReference) *NullableMenuLocationReference {
	return &NullableMenuLocationReference{value: val, isSet: true}
}

func (v NullableMenuLocationReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMenuLocationReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
