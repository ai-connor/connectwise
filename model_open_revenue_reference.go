...
// checks if the OpenRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenRevenueReference{}

// OpenRevenueReference struct for OpenRevenueReference
...
type _OpenRevenueReference OpenRevenueReference
...
func (o *OpenRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *OpenRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
func (o *OpenRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *OpenRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *OpenRevenueReference) SetPercentageNil() {
...
func (o OpenRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o OpenRevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *OpenRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varOpenRevenueReference := _OpenRevenueReference{}

	err = json.Unmarshal(data, &varOpenRevenueReference)

	if err != nil {
		return err
	}

	*o = OpenRevenueReference(varOpenRevenueReference)
...
type NullableOpenRevenueReference struct {
	value *OpenRevenueReference
	isSet bool
}

func (v NullableOpenRevenueReference) Get() *OpenRevenueReference {
	return v.value
}

func (v *NullableOpenRevenueReference) Set(val *OpenRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenRevenueReference(val *OpenRevenueReference) *NullableOpenRevenueReference {
	return &NullableOpenRevenueReference{value: val, isSet: true}
}

func (v NullableOpenRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
