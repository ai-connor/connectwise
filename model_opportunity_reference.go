...
type _OpportunityReference OpportunityReference
...
func (o *OpportunityReference) UnmarshalJSON(data []byte) (err error) {
	varOpportunityReference := _OpportunityReference{}

	err = json.Unmarshal(data, &varOpportunityReference)

	if err != nil {
		return err
	}

	*o = OpportunityReference(varOpportunityReference)
