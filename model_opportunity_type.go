...
// checks if the OpportunityType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpportunityType{}

// OpportunityType struct for OpportunityType
...
type _OpportunityType OpportunityType
...
func (o *OpportunityType) SetInactiveFlagNil() {
...
func (o OpportunityType) MarshalJSON() ([]byte, error) {
...
func (o OpportunityType) ToMap() (map[string]interface{}, error) {
...
func (o *OpportunityType) UnmarshalJSON(data []byte) (err error) {
	...
	varOpportunityType := _OpportunityType{}

	err = json.Unmarshal(data, &varOpportunityType)

	if err != nil {
		return err
	}

	*o = OpportunityType(varOpportunityType)
...
type NullableOpportunityType struct {
	value *OpportunityType
	isSet bool
}

func (v NullableOpportunityType) Get() *OpportunityType {
	return v.value
}

func (v *NullableOpportunityType) Set(val *OpportunityType) {
	v.value = val
	v.isSet = true
}

func (v NullableOpportunityType) IsSet() bool {
	return v.isSet
}

func (v *NullableOpportunityType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpportunityType(val *OpportunityType) *NullableOpportunityType {
	return &NullableOpportunityType{value: val, isSet: true}
}

func (v NullableOpportunityType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpportunityType) UnmarshalJSON(src []byte) error {
	v.isSet = true
