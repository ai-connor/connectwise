...
// checks if the OrderStatusReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderStatusReference{}

// OrderStatusReference struct for OrderStatusReference
...
func (o *OrderStatusReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o OrderStatusReference) MarshalJSON() ([]byte, error) {
...
func (o OrderStatusReference) ToMap() (map[string]interface{}, error) {
...
type NullableOrderStatusReference struct {
	value *OrderStatusReference
	isSet bool
}

func (v NullableOrderStatusReference) Get() *OrderStatusReference {
	return v.value
}

func (v *NullableOrderStatusReference) Set(val *OrderStatusReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderStatusReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderStatusReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderStatusReference(val *OrderStatusReference) *NullableOrderStatusReference {
	return &NullableOrderStatusReference{value: val, isSet: true}
}

func (v NullableOrderStatusReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderStatusReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
