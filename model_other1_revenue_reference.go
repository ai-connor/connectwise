...
// checks if the Other1RevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Other1RevenueReference{}

// Other1RevenueReference struct for Other1RevenueReference
...
type _Other1RevenueReference Other1RevenueReference
...
func (o *Other1RevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *Other1RevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *Other1RevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Other1RevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Other1RevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *Other1RevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *Other1RevenueReference) SetPercentageNil() {
...
func (o *Other1RevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o Other1RevenueReference) MarshalJSON() ([]byte, error) {
...
func (o Other1RevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *Other1RevenueReference) UnmarshalJSON(data []byte) (err error) {
	varOther1RevenueReference := _Other1RevenueReference{}

	err = json.Unmarshal(data, &varOther1RevenueReference)

	if err != nil {
		return err
	}

	*o = Other1RevenueReference(varOther1RevenueReference)
...
type NullableOther1RevenueReference struct {
	value *Other1RevenueReference
	isSet bool
}

func (v NullableOther1RevenueReference) Get() *Other1RevenueReference {
	return v.value
}

func (v *NullableOther1RevenueReference) Set(val *Other1RevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOther1RevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOther1RevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOther1RevenueReference(val *Other1RevenueReference) *NullableOther1RevenueReference {
	return &NullableOther1RevenueReference{value: val, isSet: true}
}

func (v NullableOther1RevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOther1RevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
