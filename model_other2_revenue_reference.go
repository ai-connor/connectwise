...
// checks if the Other2RevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Other2RevenueReference{}

// Other2RevenueReference struct for Other2RevenueReference
...
type _Other2RevenueReference Other2RevenueReference
...
func (o *Other2RevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *Other2RevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *Other2RevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Other2RevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Other2RevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *Other2RevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *Other2RevenueReference) SetPercentageNil() {
...
func (o *Other2RevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o Other2RevenueReference) MarshalJSON() ([]byte, error) {
...
func (o Other2RevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *Other2RevenueReference) UnmarshalJSON(data []byte) (err error) {
	varOther2RevenueReference := _Other2RevenueReference{}

	err = json.Unmarshal(data, &varOther2RevenueReference)

	if err != nil {
		return err
	}

	*o = Other2RevenueReference(varOther2RevenueReference)
...
type NullableOther2RevenueReference struct {
	value *Other2RevenueReference
	isSet bool
}

func (v NullableOther2RevenueReference) Get() *Other2RevenueReference {
	return v.value
}

func (v *NullableOther2RevenueReference) Set(val *Other2RevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOther2RevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOther2RevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOther2RevenueReference(val *Other2RevenueReference) *NullableOther2RevenueReference {
	return &NullableOther2RevenueReference{value: val, isSet: true}
}

func (v NullableOther2RevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOther2RevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
