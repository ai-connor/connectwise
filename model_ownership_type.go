...
// checks if the OwnershipType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OwnershipType{}

// OwnershipType struct for OwnershipType
...
type _OwnershipType OwnershipType
...
func (o *OwnershipType) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *OwnershipType) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *OwnershipType) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *OwnershipType) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}

func (o OwnershipType) MarshalJSON() ([]byte, error) {
...
func (o OwnershipType) ToMap() (map[string]interface{}, error) {
...
func (o *OwnershipType) UnmarshalJSON(data []byte) (err error) {
	...
	varOwnershipType := _OwnershipType{}

	err = json.Unmarshal(data, &varOwnershipType)

	if err != nil {
		return err
	}

	*o = OwnershipType(varOwnershipType)
