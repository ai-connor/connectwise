...
// checks if the ParsingVariable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParsingVariable{}

// ParsingVariable struct for ParsingVariable
...
func (o ParsingVariable) MarshalJSON() ([]byte, error) {
...
func (o ParsingVariable) ToMap() (map[string]interface{}, error) {
...
type NullableParsingVariable struct {
	value *ParsingVariable
	isSet bool
}

func (v NullableParsingVariable) Get() *ParsingVariable {
	return v.value
}

func (v *NullableParsingVariable) Set(val *ParsingVariable) {
	v.value = val
	v.isSet = true
}

func (v NullableParsingVariable) IsSet() bool {
	return v.isSet
}

func (v *NullableParsingVariable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParsingVariable(val *ParsingVariable) *NullableParsingVariable {
	return &NullableParsingVariable{value: val, isSet: true}
}

func (v NullableParsingVariable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParsingVariable) UnmarshalJSON(src []byte) error {
	v.isSet = true
