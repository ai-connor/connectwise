...
// checks if the PaymentTypeInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentTypeInfo{}

// PaymentTypeInfo struct for PaymentTypeInfo
...
type _PaymentTypeInfo PaymentTypeInfo
...
func (o *PaymentTypeInfo) SetDefaultFlagNil() {
...
func (o PaymentTypeInfo) MarshalJSON() ([]byte, error) {
...
func (o PaymentTypeInfo) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentTypeInfo) UnmarshalJSON(data []byte) (err error) {
	varPaymentTypeInfo := _PaymentTypeInfo{}

	err = json.Unmarshal(data, &varPaymentTypeInfo)

	if err != nil {
		return err
	}

	*o = PaymentTypeInfo(varPaymentTypeInfo)
...
type NullablePaymentTypeInfo struct {
	value *PaymentTypeInfo
	isSet bool
}

func (v NullablePaymentTypeInfo) Get() *PaymentTypeInfo {
	return v.value
}

func (v *NullablePaymentTypeInfo) Set(val *PaymentTypeInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentTypeInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentTypeInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentTypeInfo(val *PaymentTypeInfo) *NullablePaymentTypeInfo {
	return &NullablePaymentTypeInfo{value: val, isSet: true}
}

func (v NullablePaymentTypeInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentTypeInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
