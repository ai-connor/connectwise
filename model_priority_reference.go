...
// checks if the PriorityReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriorityReference{}

// PriorityReference struct for PriorityReference
...
type _PriorityReference PriorityReference
...
func (o *PriorityReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PriorityReference) SetSortNil() {
	o.Sort.Set(nil)
}
...
func (o PriorityReference) MarshalJSON() ([]byte, error) {
...
func (o PriorityReference) ToMap() (map[string]interface{}, error) {
...
func (o *PriorityReference) UnmarshalJSON(data []byte) (err error) {
	varPriorityReference := _PriorityReference{}

	err = json.Unmarshal(data, &varPriorityReference)

	if err != nil {
		return err
	}

	*o = PriorityReference(varPriorityReference)
...
type NullablePriorityReference struct {
	value *PriorityReference
	isSet bool
}

func (v NullablePriorityReference) Get() *PriorityReference {
	return v.value
}

func (v *NullablePriorityReference) Set(val *PriorityReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePriorityReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePriorityReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriorityReference(val *PriorityReference) *NullablePriorityReference {
	return &NullablePriorityReference{value: val, isSet: true}
}

func (v NullablePriorityReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriorityReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
