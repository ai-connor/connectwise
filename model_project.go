...
// GetOverridePercentComplete returns the OverridePercentComplete field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Project) GetOverridePercentComplete() bool {
	if o == nil || IsNil(o.OverridePercentComplete.Get()) {
		var ret bool
		return ret
	}
	return *o.OverridePercentComplete.Get()
}

// GetOverridePercentCompleteOk returns a tuple with the OverridePercentComplete field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Project) GetOverridePercentCompleteOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.OverridePercentComplete.Get(), o.OverridePercentComplete.IsSet()
}

// HasOverridePercentComplete returns a boolean if a field has been set.
func (o *Project) HasOverridePercentComplete() bool {
	if o != nil && o.OverridePercentComplete.IsSet() {
		return true
	}
...
// SetOverridePercentComplete gets a reference to the given NullableBool and assigns it to the OverridePercentComplete field.
func (o *Project) SetOverridePercentComplete(v bool) {
	o.OverridePercentComplete.Set(&v)
}
// SetOverridePercentCompleteNil sets the value for OverridePercentComplete to be an explicit nil
func (o *Project) SetOverridePercentCompleteNil() {
	o.OverridePercentComplete.Set(nil)
}

// UnsetOverridePercentComplete ensures that no value is present for OverridePercentComplete, not even an explicit nil
func (o *Project) UnsetOverridePercentComplete() {
	o.OverridePercentComplete.Unset()
}

// GetShowOverridePercentFlag returns the ShowOverridePercentFlag field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Project) GetShowOverridePercentFlag() bool {
	if o == nil || IsNil(o.ShowOverridePercentFlag.Get()) {
		var ret bool
		return ret
	}
	return *o.ShowOverridePercentFlag.Get()
}

// GetShowOverridePercentFlagOk returns a tuple with the ShowOverridePercentFlag field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Project) GetShowOverridePercentFlagOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.ShowOverridePercentFlag.Get(), o.ShowOverridePercentFlag.IsSet()
}

// HasShowOverridePercentFlag returns a boolean if a field has been set.
func (o *Project) HasShowOverridePercentFlag() bool {
	if o != nil && o.ShowOverridePercentFlag.IsSet() {
		return true
	}
...
// SetShowOverridePercentFlag gets a reference to the given NullableBool and assigns it to the ShowOverridePercentFlag field.
func (o *Project) SetShowOverridePercentFlag(v bool) {
	o.ShowOverridePercentFlag.Set(&v)
}
// SetShowOverridePercentFlagNil sets the value for ShowOverridePercentFlag to be an explicit nil
func (o *Project) SetShowOverridePercentFlagNil() {
	o.ShowOverridePercentFlag.Set(nil)
}

// UnsetShowOverridePercentFlag ensures that no value is present for ShowOverridePercentFlag, not even an explicit nil
func (o *Project) UnsetShowOverridePercentFlag() {
	o.ShowOverridePercentFlag.Unset()
}
...
func (o Project) ToMap() (map[string]interface{}, error) {
	...
	if o.OverridePercentComplete.IsSet() {
		toSerialize["overridePercentComplete"] = o.OverridePercentComplete.Get()
	}
	if o.ShowOverridePercentFlag.IsSet() {
		toSerialize["showOverridePercentFlag"] = o.ShowOverridePercentFlag.Get()
	}
