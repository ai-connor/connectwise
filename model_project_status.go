...
func (o *ProjectStatus) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ProjectStatus) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ProjectStatus) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ProjectStatus) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
