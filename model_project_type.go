...
// ProjectType struct for ProjectType
...
func (o *ProjectType) SetDefaultFlagNil() {
...
func (o *ProjectType) SetInactiveFlagNil() {
...
func (o *ProjectType) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectType := _ProjectType{}

	err = json.Unmarshal(data, &varProjectType)

	if err != nil {
		return err
	}

	*o = ProjectType(varProjectType)
