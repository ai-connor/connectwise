...
// checks if the ProjectTypeInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTypeInfo{}

// ProjectTypeInfo struct for ProjectTypeInfo
...
type _ProjectTypeInfo ProjectTypeInfo
...
func (o *ProjectTypeInfo) SetDefaultFlagNil() {
...
func (o *ProjectTypeInfo) SetInactiveFlagNil() {
...
func (o ProjectTypeInfo) MarshalJSON() ([]byte, error) {
...
func (o ProjectTypeInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectTypeInfo) UnmarshalJSON(data []byte) (err error) {
	varProjectTypeInfo := _ProjectTypeInfo{}

	err = json.Unmarshal(data, &varProjectTypeInfo)

	if err != nil {
		return err
	}

	*o = ProjectTypeInfo(varProjectTypeInfo)
...
type NullableProjectTypeInfo struct {
	value *ProjectTypeInfo
	isSet bool
}

func (v NullableProjectTypeInfo) Get() *ProjectTypeInfo {
	return v.value
}

func (v *NullableProjectTypeInfo) Set(val *ProjectTypeInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTypeInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTypeInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTypeInfo(val *ProjectTypeInfo) *NullableProjectTypeInfo {
	return &NullableProjectTypeInfo{value: val, isSet: true}
}

func (v NullableProjectTypeInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTypeInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
