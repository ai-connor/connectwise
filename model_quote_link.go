...
// GetAsioQuotingFlag returns the AsioQuotingFlag field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *QuoteLink) GetAsioQuotingFlag() bool {
	if o == nil || IsNil(o.AsioQuotingFlag.Get()) {
		var ret bool
		return ret
	}
	return *o.AsioQuotingFlag.Get()
}

// GetAsioQuotingFlagOk returns a tuple with the AsioQuotingFlag field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *QuoteLink) GetAsioQuotingFlagOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.AsioQuotingFlag.Get(), o.AsioQuotingFlag.IsSet()
}

// HasAsioQuotingFlag returns a boolean if a field has been set.
func (o *QuoteLink) HasAsioQuotingFlag() bool {
	if o != nil && o.AsioQuotingFlag.IsSet() {
		return true
	}
...
// SetAsioQuotingFlag gets a reference to the given NullableBool and assigns it to the AsioQuotingFlag field.
func (o *QuoteLink) SetAsioQuotingFlag(v bool) {
	o.AsioQuotingFlag.Set(&v)
}
// SetAsioQuotingFlagNil sets the value for AsioQuotingFlag to be an explicit nil
func (o *QuoteLink) SetAsioQuotingFlagNil() {
	o.AsioQuotingFlag.Set(nil)
}

// UnsetAsioQuotingFlag ensures that no value is present for AsioQuotingFlag, not even an explicit nil
func (o *QuoteLink) UnsetAsioQuotingFlag() {
	o.AsioQuotingFlag.Unset()
}
...
func (o QuoteLink) ToMap() (map[string]interface{}, error) {
	...
	if o.AsioQuotingFlag.IsSet() {
		toSerialize["asioQuotingFlag"] = o.AsioQuotingFlag.Get()
	}
	if !IsNil(o.Info) {
