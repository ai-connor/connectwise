...
type _RmaStatusInfo RmaStatusInfo
...
func (o *RmaStatusInfo) UnmarshalJSON(data []byte) (err error) {
	varRmaStatusInfo := _RmaStatusInfo{}

	err = json.Unmarshal(data, &varRmaStatusInfo)

	if err != nil {
		return err
	}

	*o = RmaStatusInfo(varRmaStatusInfo)
