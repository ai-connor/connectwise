...
func (o *SalesTeam) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSalesTeam)
	...
	*o = SalesTeam(varSalesTeam)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "salesTeamIdentifier")
		delete(additionalProperties, "salesTeamDescription")
		delete(additionalProperties, "salesTeamLocation")
