...
type _ScheduleEntryReference ScheduleEntryReference
...
func (o *ScheduleEntryReference) UnmarshalJSON(data []byte) (err error) {
	varScheduleEntryReference := _ScheduleEntryReference{}

	err = json.Unmarshal(data, &varScheduleEntryReference)

	if err != nil {
		return err
	}

	*o = ScheduleEntryReference(varScheduleEntryReference)
