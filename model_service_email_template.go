...
func (o *ServiceEmailTemplate) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceEmailTemplate) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ServiceEmailTemplate) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ServiceEmailTemplate) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
