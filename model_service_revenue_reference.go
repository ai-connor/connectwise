...
// checks if the ServiceRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceRevenueReference{}

// ServiceRevenueReference struct for ServiceRevenueReference
...
type _ServiceRevenueReference ServiceRevenueReference
...
func (o *ServiceRevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *ServiceRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ServiceRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServiceRevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *ServiceRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *ServiceRevenueReference) SetPercentageNil() {
...
func (o *ServiceRevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o ServiceRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o ServiceRevenueReference) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceRevenueReference) UnmarshalJSON(data []byte) (err error) {
	varServiceRevenueReference := _ServiceRevenueReference{}

	err = json.Unmarshal(data, &varServiceRevenueReference)

	if err != nil {
		return err
	}

	*o = ServiceRevenueReference(varServiceRevenueReference)
...
type NullableServiceRevenueReference struct {
	value *ServiceRevenueReference
	isSet bool
}

func (v NullableServiceRevenueReference) Get() *ServiceRevenueReference {
	return v.value
}

func (v *NullableServiceRevenueReference) Set(val *ServiceRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceRevenueReference(val *ServiceRevenueReference) *NullableServiceRevenueReference {
	return &NullableServiceRevenueReference{value: val, isSet: true}
}

func (v NullableServiceRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
