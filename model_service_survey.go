...
func (o *ServiceSurvey) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceSurvey) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *ServiceSurvey) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *ServiceSurvey) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
