...
// checks if the ShipmentMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentMethod{}
...
func (o *ShipmentMethod) SetDefaultFlagNil() {
...
func (o ShipmentMethod) MarshalJSON() ([]byte, error) {
...
func (o ShipmentMethod) ToMap() (map[string]interface{}, error) {
...
func (o *ShipmentMethod) UnmarshalJSON(data []byte) (err error) {
...
type NullableShipmentMethod struct {
	value *ShipmentMethod
	isSet bool
}

func (v NullableShipmentMethod) Get() *ShipmentMethod {
	return v.value
}

func (v *NullableShipmentMethod) Set(val *ShipmentMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableShipmentMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableShipmentMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipmentMethod(val *ShipmentMethod) *NullableShipmentMethod {
	return &NullableShipmentMethod{value: val, isSet: true}
}

func (v NullableShipmentMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipmentMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
