...
func (o *SurveyInfo) UnmarshalJSON(data []byte) (err error) {
	varSurveyInfo := _SurveyInfo{}

	err = json.Unmarshal(data, &varSurveyInfo)

	if err != nil {
		return err
	}

	*o = SurveyInfo(varSurveyInfo)
