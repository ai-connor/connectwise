...
// checks if the TaxableExpenseTypeLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxableExpenseTypeLevel{}

// TaxableExpenseTypeLevel struct for TaxableExpenseTypeLevel
...
type _TaxableExpenseTypeLevel TaxableExpenseTypeLevel
...
func (o TaxableExpenseTypeLevel) MarshalJSON() ([]byte, error) {
...
func (o TaxableExpenseTypeLevel) ToMap() (map[string]interface{}, error) {
...
func (o *TaxableExpenseTypeLevel) UnmarshalJSON(data []byte) (err error) {
	...
	varTaxableExpenseTypeLevel := _TaxableExpenseTypeLevel{}

	err = json.Unmarshal(data, &varTaxableExpenseTypeLevel)

	if err != nil {
		return err
	}

	*o = TaxableExpenseTypeLevel(varTaxableExpenseTypeLevel)
...
type NullableTaxableExpenseTypeLevel struct {
	value *TaxableExpenseTypeLevel
	isSet bool
}

func (v NullableTaxableExpenseTypeLevel) Get() *TaxableExpenseTypeLevel {
	return v.value
}

func (v *NullableTaxableExpenseTypeLevel) Set(val *TaxableExpenseTypeLevel) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxableExpenseTypeLevel) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxableExpenseTypeLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxableExpenseTypeLevel(val *TaxableExpenseTypeLevel) *NullableTaxableExpenseTypeLevel {
	return &NullableTaxableExpenseTypeLevel{value: val, isSet: true}
}

func (v NullableTaxableExpenseTypeLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxableExpenseTypeLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
