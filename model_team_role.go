...
func (o *TeamRole) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *TeamRole) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *TeamRole) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *TeamRole) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
