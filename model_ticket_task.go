...
func (o *TicketTask) UnmarshalJSON(data []byte) (err error) {
	varTicketTask := _TicketTask{}

	err = json.Unmarshal(data, &varTicketTask)

	if err != nil {
		return err
	}

	*o = TicketTask(varTicketTask)
