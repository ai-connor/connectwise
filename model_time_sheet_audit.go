...
type _TimeSheetAudit TimeSheetAudit
...
func (o *TimeSheetAudit) UnmarshalJSON(data []byte) (err error) {
	varTimeSheetAudit := _TimeSheetAudit{}

	err = json.Unmarshal(data, &varTimeSheetAudit)

	if err != nil {
		return err
	}

	*o = TimeSheetAudit(varTimeSheetAudit)
