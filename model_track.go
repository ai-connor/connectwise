...
func (o *Track) GetConnectWiseId() string {
...
// and a boolean to check if the value has been set.
func (o *Track) GetConnectWiseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectWiseId) {
		return nil, false
	}
...
func (o *Track) HasConnectWiseId() bool {
	if o != nil && !IsNil(o.ConnectWiseId) {
		return true
	}
...
func (o *Track) SetConnectWiseId(v string) {
	o.ConnectWiseId = &v
}
...
func (o *Track) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTrack)
	...
	*o = Track(varTrack)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "notifyActionIds")
