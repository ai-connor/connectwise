...
type _TypeSubTypeCampaignSubType TypeSubTypeCampaignSubType
...
func (o *TypeSubTypeCampaignSubType) UnmarshalJSON(data []byte) (err error) {
	varTypeSubTypeCampaignSubType := _TypeSubTypeCampaignSubType{}

	err = json.Unmarshal(data, &varTypeSubTypeCampaignSubType)

	if err != nil {
		return err
	}

	*o = TypeSubTypeCampaignSubType(varTypeSubTypeCampaignSubType)
