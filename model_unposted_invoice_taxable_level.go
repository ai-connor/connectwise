...
// checks if the UnpostedInvoiceTaxableLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnpostedInvoiceTaxableLevel{}

// UnpostedInvoiceTaxableLevel struct for UnpostedInvoiceTaxableLevel
...
type _UnpostedInvoiceTaxableLevel UnpostedInvoiceTaxableLevel
...
func NewUnpostedInvoiceTaxableLevel() *UnpostedInvoiceTaxableLevel {
	this := UnpostedInvoiceTaxableLevel{}
	return &this
}
...
func (o *UnpostedInvoiceTaxableLevel) SetTaxAmountNil() {
	o.TaxAmount.Set(nil)
}
...
func (o UnpostedInvoiceTaxableLevel) MarshalJSON() ([]byte, error) {
...
func (o UnpostedInvoiceTaxableLevel) ToMap() (map[string]interface{}, error) {
...
func (o *UnpostedInvoiceTaxableLevel) UnmarshalJSON(data []byte) (err error) {
	varUnpostedInvoiceTaxableLevel := _UnpostedInvoiceTaxableLevel{}

	err = json.Unmarshal(data, &varUnpostedInvoiceTaxableLevel)

	if err != nil {
		return err
	}

	*o = UnpostedInvoiceTaxableLevel(varUnpostedInvoiceTaxableLevel)
...
type NullableUnpostedInvoiceTaxableLevel struct {
	value *UnpostedInvoiceTaxableLevel
	isSet bool
}

func (v NullableUnpostedInvoiceTaxableLevel) Get() *UnpostedInvoiceTaxableLevel {
	return v.value
}

func (v *NullableUnpostedInvoiceTaxableLevel) Set(val *UnpostedInvoiceTaxableLevel) {
	v.value = val
	v.isSet = true
}

func (v NullableUnpostedInvoiceTaxableLevel) IsSet() bool {
	return v.isSet
}

func (v *NullableUnpostedInvoiceTaxableLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnpostedInvoiceTaxableLevel(val *UnpostedInvoiceTaxableLevel) *NullableUnpostedInvoiceTaxableLevel {
	return &NullableUnpostedInvoiceTaxableLevel{value: val, isSet: true}
}

func (v NullableUnpostedInvoiceTaxableLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnpostedInvoiceTaxableLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
