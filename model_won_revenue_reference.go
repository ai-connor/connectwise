...
// checks if the WonRevenueReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WonRevenueReference{}

// WonRevenueReference struct for WonRevenueReference
...
func (o *WonRevenueReference) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *WonRevenueReference) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *WonRevenueReference) SetRevenueNil() {
	o.Revenue.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WonRevenueReference) GetCostOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WonRevenueReference) SetCostNil() {
	o.Cost.Set(nil)
}
...
func (o *WonRevenueReference) SetMarginNil() {
	o.Margin.Set(nil)
}
...
func (o *WonRevenueReference) SetPercentageNil() {
...
func (o *WonRevenueReference) SetInfo(v map[string]string) {
	o.Info = &v
}

func (o WonRevenueReference) MarshalJSON() ([]byte, error) {
...
func (o WonRevenueReference) ToMap() (map[string]interface{}, error) {
...
type NullableWonRevenueReference struct {
	value *WonRevenueReference
	isSet bool
}

func (v NullableWonRevenueReference) Get() *WonRevenueReference {
	return v.value
}

func (v *NullableWonRevenueReference) Set(val *WonRevenueReference) {
	v.value = val
	v.isSet = true
}

func (v NullableWonRevenueReference) IsSet() bool {
	return v.isSet
}

func (v *NullableWonRevenueReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWonRevenueReference(val *WonRevenueReference) *NullableWonRevenueReference {
	return &NullableWonRevenueReference{value: val, isSet: true}
}

func (v NullableWonRevenueReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWonRevenueReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
