...
// checks if the WorkRoleInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkRoleInfo{}

// WorkRoleInfo struct for WorkRoleInfo
...
type _WorkRoleInfo WorkRoleInfo
...
func (o *WorkRoleInfo) SetInactiveFlagNil() {
...
func (o WorkRoleInfo) MarshalJSON() ([]byte, error) {
...
func (o WorkRoleInfo) ToMap() (map[string]interface{}, error) {
...
func (o *WorkRoleInfo) UnmarshalJSON(data []byte) (err error) {
	varWorkRoleInfo := _WorkRoleInfo{}

	err = json.Unmarshal(data, &varWorkRoleInfo)

	if err != nil {
		return err
	}

	*o = WorkRoleInfo(varWorkRoleInfo)
...
type NullableWorkRoleInfo struct {
	value *WorkRoleInfo
	isSet bool
}

func (v NullableWorkRoleInfo) Get() *WorkRoleInfo {
	return v.value
}

func (v *NullableWorkRoleInfo) Set(val *WorkRoleInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkRoleInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkRoleInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkRoleInfo(val *WorkRoleInfo) *NullableWorkRoleInfo {
	return &NullableWorkRoleInfo{value: val, isSet: true}
}

func (v NullableWorkRoleInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkRoleInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
