...
type _WorkflowAttachment WorkflowAttachment
...
func (o *WorkflowAttachment) UnmarshalJSON(data []byte) (err error) {
	varWorkflowAttachment := _WorkflowAttachment{}

	err = json.Unmarshal(data, &varWorkflowAttachment)

	if err != nil {
		return err
	}

	*o = WorkflowAttachment(varWorkflowAttachment)
