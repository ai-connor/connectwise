...
// checks if the WorkflowTableType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTableType{}

// WorkflowTableType struct for WorkflowTableType
...
type _WorkflowTableType WorkflowTableType
...
func (o WorkflowTableType) MarshalJSON() ([]byte, error) {
...
func (o WorkflowTableType) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTableType) UnmarshalJSON(data []byte) (err error) {
	varWorkflowTableType := _WorkflowTableType{}

	err = json.Unmarshal(data, &varWorkflowTableType)

	if err != nil {
		return err
	}

	*o = WorkflowTableType(varWorkflowTableType)
...
type NullableWorkflowTableType struct {
	value *WorkflowTableType
	isSet bool
}

func (v NullableWorkflowTableType) Get() *WorkflowTableType {
	return v.value
}

func (v *NullableWorkflowTableType) Set(val *WorkflowTableType) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTableType) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTableType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTableType(val *WorkflowTableType) *NullableWorkflowTableType {
	return &NullableWorkflowTableType{value: val, isSet: true}
}

func (v NullableWorkflowTableType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTableType) UnmarshalJSON(src []byte) error {
	v.isSet = true
