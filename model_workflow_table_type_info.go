...
// checks if the WorkflowTableTypeInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTableTypeInfo{}

// WorkflowTableTypeInfo struct for WorkflowTableTypeInfo
...
func (o WorkflowTableTypeInfo) MarshalJSON() ([]byte, error) {
...
func (o WorkflowTableTypeInfo) ToMap() (map[string]interface{}, error) {
...
type NullableWorkflowTableTypeInfo struct {
	value *WorkflowTableTypeInfo
	isSet bool
}

func (v NullableWorkflowTableTypeInfo) Get() *WorkflowTableTypeInfo {
	return v.value
}

func (v *NullableWorkflowTableTypeInfo) Set(val *WorkflowTableTypeInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTableTypeInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTableTypeInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTableTypeInfo(val *WorkflowTableTypeInfo) *NullableWorkflowTableTypeInfo {
	return &NullableWorkflowTableTypeInfo{value: val, isSet: true}
}

func (v NullableWorkflowTableTypeInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTableTypeInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
